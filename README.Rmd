...
*Note: The following creates stopifnot statements, using the `..._sin()` family of functions. For more more informative error messages using if statements and `cli::cli_abort()` messages, use the `..._cli()` family of functions.*
